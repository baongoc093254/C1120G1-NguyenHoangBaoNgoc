...
<%--        </thead>--%>
<%--        <tbody>--%>
<%--        <c:forEach items="${customerId}" var="customer">--%>
<%--            <tr>--%>
...
<%--                    &lt;%&ndash;            <td><a href="/customer?action=delete&id=${customer.getCustomer_id()}" ><button type="button" class="btn btn-danger" ><i class="fas fa-user-slash"></i></button></a></td>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;            onclick="customerSetId('${customer.getCustomer_id()}','${customer.getCustomer_name()}')"&ndash;%&gt;--%>
<%--            </tr>--%>
<%--        </c:forEach>--%>
...
<%--&lt;%&ndash;<form>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <input type="hidden" name="actionUser" value="searchById"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <input type="text" name="id" placeholder="Search By Id"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <input type="submit" value="Search"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;</form>&ndash;%&gt;--%>

<%--&lt;%&ndash;<form>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <input type="hidden" name="actionUser" value="searchByName"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <input type="text" name="name" placeholder="Search By Name"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <input type="submit" value="Search"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;</form>&ndash;%&gt;--%>