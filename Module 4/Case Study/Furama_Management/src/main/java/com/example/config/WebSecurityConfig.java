...
import com.example.service.employee.UserDetailsServiceImpl;
...
//                .and().exceptionHandling().accessDeniedPage("/403");
        ...
        http.authorizeRequests().antMatchers("/customer/",
                ...
                "/contractdetail/",
                "/contract_list/",
                "/service/").access("hasAnyRole('ROLE_MANAGE', 'ROLE_PRINCIPAL', 'ROLE_EMPLOYEE')");


        // Trang chỉ dành cho Giam doc va quan ly
        http.authorizeRequests().antMatchers("/customer/create",
                ...
                "/employee/delete/**",
                "/contract/create",
                "/contracdetail/create",
                "/service/create").access("hasAnyRole('ROLE_MANAGE', 'ROLE_PRINCIPAL')");
