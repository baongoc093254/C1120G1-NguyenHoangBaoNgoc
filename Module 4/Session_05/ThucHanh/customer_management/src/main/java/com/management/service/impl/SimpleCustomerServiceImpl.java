...
public class SimpleCustomerServiceImpl implements CustomerService {
    ...
    static {
        customers = asList(
                new Customer(autoIncreaseId++, "Thinh", "thinh@codegym.vn", "Da Nang"),
                new Customer(autoIncreaseId++, "Hoang", "hoang@codegym.vn", "Quang Tri"),
                new Customer(autoIncreaseId++, "Thuan", "thuan@codegym.vn", "Ha Noi"),
                new Customer(autoIncreaseId++, "Nguyen Binh Sang", "binhsang@codegym.vn", "Sai Gon"),
                new Customer(autoIncreaseId++, "Nguyen Van Phuc", "phucnguyen@codegym.vn", "Da Nang")
        );
    }
